# pulpcore.client.pulp_rpm.ExportersFilesystemApi

All URIs are relative to *http://localhost:8000*

Method | HTTP request | Description
------------- | ------------- | -------------
[**exporters_core_filesystem_create**](ExportersFilesystemApi.md#exporters_core_filesystem_create) | **POST** /api/pulp/{pulp_domain}/api/v3/exporters/core/filesystem/ | Create a filesystem exporter
...
[**exporters_core_filesystem_list**](ExportersFilesystemApi.md#exporters_core_filesystem_list) | **GET** /api/pulp/{pulp_domain}/api/v3/exporters/core/filesystem/ | List filesystem exporters
...
> FilesystemExporterResponse exporters_core_filesystem_create(pulp_domain, filesystem_exporter)
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.ExportersFilesystemApi(api_client)
    pulp_domain = 'pulp_domain_example' # str | 
filesystem_exporter = pulpcore.client.pulp_rpm.FilesystemExporter() # FilesystemExporter | 

    try:
        # Create a filesystem exporter
        api_response = api_instance.exporters_core_filesystem_create(pulp_domain, filesystem_exporter)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ExportersFilesystemApi->exporters_core_filesystem_create: %s\n" % e)
```
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a filesystem exporter
        api_response = api_instance.exporters_core_filesystem_delete(filesystem_exporter_href)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ExportersFilesystemApi->exporters_core_filesystem_delete: %s\n" % e)
```
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List filesystem exporters
        api_response = api_instance.exporters_core_filesystem_list(pulp_domain, limit=limit, name=name, name__contains=name__contains, name__icontains=name__icontains, name__iexact=name__iexact, name__in=name__in, name__iregex=name__iregex, name__istartswith=name__istartswith, name__regex=name__regex, name__startswith=name__startswith, offset=offset, ordering=ordering, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, q=q, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ExportersFilesystemApi->exporters_core_filesystem_list: %s\n" % e)
```
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.ExportersFilesystemApi(api_client)
    filesystem_exporter_href = 'filesystem_exporter_href_example' # str | 
patched_filesystem_exporter = pulpcore.client.pulp_rpm.PatchedFilesystemExporter() # PatchedFilesystemExporter | 

    try:
        # Update a filesystem exporter
        api_response = api_instance.exporters_core_filesystem_partial_update(filesystem_exporter_href, patched_filesystem_exporter)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ExportersFilesystemApi->exporters_core_filesystem_partial_update: %s\n" % e)
```
...
> FilesystemExporterResponse exporters_core_filesystem_read(filesystem_exporter_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a filesystem exporter
        api_response = api_instance.exporters_core_filesystem_read(filesystem_exporter_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ExportersFilesystemApi->exporters_core_filesystem_read: %s\n" % e)
```
...
filesystem_exporter = pulpcore.client.pulp_rpm.FilesystemExporter() # FilesystemExporter | 
    ...
    try:
        # Update a filesystem exporter
        api_response = api_instance.exporters_core_filesystem_update(filesystem_exporter_href, filesystem_exporter)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ExportersFilesystemApi->exporters_core_filesystem_update: %s\n" % e)
```

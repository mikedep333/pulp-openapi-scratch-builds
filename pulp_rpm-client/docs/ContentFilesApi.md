# pulpcore.client.pulp_rpm.ContentFilesApi

All URIs are relative to *http://localhost:8000*

Method | HTTP request | Description
------------- | ------------- | -------------
[**content_file_files_create**](ContentFilesApi.md#content_file_files_create) | **POST** /api/pulp/{pulp_domain}/api/v3/content/file/files/ | Create a file content
[**content_file_files_list**](ContentFilesApi.md#content_file_files_list) | **GET** /api/pulp/{pulp_domain}/api/v3/content/file/files/ | List file contents
[**content_file_files_read**](ContentFilesApi.md#content_file_files_read) | **GET** {file_file_content_href} | Inspect a file content


# **content_file_files_create**
> AsyncOperationResponse content_file_files_create(pulp_domain, relative_path, repository=repository, artifact=artifact, file=file, upload=upload, url=url)
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.ContentFilesApi(api_client)
...
url = 'url_example' # str | A url that Pulp can download and turn into the content unit. (optional)
    ...
    try:
        # Create a file content
        api_response = api_instance.content_file_files_create(pulp_domain, relative_path, repository=repository, artifact=artifact, file=file, upload=upload, url=url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ContentFilesApi->content_file_files_create: %s\n" % e)
```
...
> PaginatedfileFileContentResponseList content_file_files_list(pulp_domain, limit=limit, offset=offset, ordering=ordering, orphaned_for=orphaned_for, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, q=q, relative_path=relative_path, repository_version=repository_version, repository_version_added=repository_version_added, repository_version_removed=repository_version_removed, sha256=sha256, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List file contents
        api_response = api_instance.content_file_files_list(pulp_domain, limit=limit, offset=offset, ordering=ordering, orphaned_for=orphaned_for, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, q=q, relative_path=relative_path, repository_version=repository_version, repository_version_added=repository_version_added, repository_version_removed=repository_version_removed, sha256=sha256, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ContentFilesApi->content_file_files_list: %s\n" % e)
```
...
> FileFileContentResponse content_file_files_read(file_file_content_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a file content
        api_response = api_instance.content_file_files_read(file_file_content_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ContentFilesApi->content_file_files_read: %s\n" % e)
```

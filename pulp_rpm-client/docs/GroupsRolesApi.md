# pulpcore.client.pulp_rpm.GroupsRolesApi
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.GroupsRolesApi(api_client)
    group_href = 'group_href_example' # str | 
group_role = pulpcore.client.pulp_rpm.GroupRole() # GroupRole | 

    try:
        # Create a group role
        api_response = api_instance.groups_roles_create(group_href, group_role)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GroupsRolesApi->groups_roles_create: %s\n" % e)
```
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GroupsRolesApi->groups_roles_delete: %s\n" % e)
```
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List group roles
        api_response = api_instance.groups_roles_list(group_href, content_object=content_object, domain=domain, limit=limit, offset=offset, ordering=ordering, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, q=q, role=role, role__contains=role__contains, role__icontains=role__icontains, role__in=role__in, role__startswith=role__startswith, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GroupsRolesApi->groups_roles_list: %s\n" % e)
```
...
# **groups_roles_read**
> GroupRoleResponse groups_roles_read(groups_group_role_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a group role
        api_response = api_instance.groups_roles_read(groups_group_role_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GroupsRolesApi->groups_roles_read: %s\n" % e)
```

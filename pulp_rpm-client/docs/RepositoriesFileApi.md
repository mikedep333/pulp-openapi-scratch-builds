# pulpcore.client.pulp_rpm.RepositoriesFileApi
...
[**repositories_file_file_create**](RepositoriesFileApi.md#repositories_file_file_create) | **POST** /api/pulp/{pulp_domain}/api/v3/repositories/file/file/ | Create a file repository
...
[**repositories_file_file_list**](RepositoriesFileApi.md#repositories_file_file_list) | **GET** /api/pulp/{pulp_domain}/api/v3/repositories/file/file/ | List file repositorys
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.RepositoriesFileApi(api_client)
...
nested_role = pulpcore.client.pulp_rpm.NestedRole() # NestedRole | 
    ...
    try:
        # Add a role
        api_response = api_instance.repositories_file_file_add_role(file_file_repository_href, nested_role)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_add_role: %s\n" % e)
```
...
> FileFileRepositoryResponse repositories_file_file_create(pulp_domain, file_file_repository)
...
file_file_repository = pulpcore.client.pulp_rpm.FileFileRepository() # FileFileRepository | 

    try:
        # Create a file repository
        api_response = api_instance.repositories_file_file_create(pulp_domain, file_file_repository)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_create: %s\n" % e)
```
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a file repository
        api_response = api_instance.repositories_file_file_delete(file_file_repository_href)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_delete: %s\n" % e)
```
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List file repositorys
        api_response = api_instance.repositories_file_file_list(pulp_domain, latest_with_content=latest_with_content, limit=limit, name=name, name__contains=name__contains, name__icontains=name__icontains, name__iexact=name__iexact, name__in=name__in, name__iregex=name__iregex, name__istartswith=name__istartswith, name__regex=name__regex, name__startswith=name__startswith, offset=offset, ordering=ordering, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, pulp_label_select=pulp_label_select, q=q, remote=remote, retain_repo_versions=retain_repo_versions, retain_repo_versions__gt=retain_repo_versions__gt, retain_repo_versions__gte=retain_repo_versions__gte, retain_repo_versions__isnull=retain_repo_versions__isnull, retain_repo_versions__lt=retain_repo_versions__lt, retain_repo_versions__lte=retain_repo_versions__lte, retain_repo_versions__ne=retain_repo_versions__ne, retain_repo_versions__range=retain_repo_versions__range, with_content=with_content, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_list: %s\n" % e)
```
...
> ObjectRolesResponse repositories_file_file_list_roles(file_file_repository_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List roles
        api_response = api_instance.repositories_file_file_list_roles(file_file_repository_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_list_roles: %s\n" % e)
```
...
repository_add_remove_content = pulpcore.client.pulp_rpm.RepositoryAddRemoveContent() # RepositoryAddRemoveContent | 
    ...
    try:
        # Modify Repository Content
        api_response = api_instance.repositories_file_file_modify(file_file_repository_href, repository_add_remove_content)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_modify: %s\n" % e)
```
...
> MyPermissionsResponse repositories_file_file_my_permissions(file_file_repository_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List user permissions
        api_response = api_instance.repositories_file_file_my_permissions(file_file_repository_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_my_permissions: %s\n" % e)
```
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.RepositoriesFileApi(api_client)
    file_file_repository_href = 'file_file_repository_href_example' # str | 
patchedfile_file_repository = pulpcore.client.pulp_rpm.PatchedfileFileRepository() # PatchedfileFileRepository | 

    try:
        # Update a file repository
        api_response = api_instance.repositories_file_file_partial_update(file_file_repository_href, patchedfile_file_repository)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_partial_update: %s\n" % e)
```
...
> FileFileRepositoryResponse repositories_file_file_read(file_file_repository_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a file repository
        api_response = api_instance.repositories_file_file_read(file_file_repository_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_read: %s\n" % e)
```
...
nested_role = pulpcore.client.pulp_rpm.NestedRole() # NestedRole | 
    ...
    try:
        # Remove a role
        api_response = api_instance.repositories_file_file_remove_role(file_file_repository_href, nested_role)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_remove_role: %s\n" % e)
```
...
set_label = pulpcore.client.pulp_rpm.SetLabel() # SetLabel | 
    ...
    try:
        # Set a label
        api_response = api_instance.repositories_file_file_set_label(file_file_repository_href, set_label)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_set_label: %s\n" % e)
```
...
repository_sync_url = pulpcore.client.pulp_rpm.RepositorySyncURL() # RepositorySyncURL | 
    ...
    try:
        # Sync from a remote
        api_response = api_instance.repositories_file_file_sync(file_file_repository_href, repository_sync_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_sync: %s\n" % e)
```
...
unset_label = pulpcore.client.pulp_rpm.UnsetLabel() # UnsetLabel | 
    ...
    try:
        # Unset a label
        api_response = api_instance.repositories_file_file_unset_label(file_file_repository_href, unset_label)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_unset_label: %s\n" % e)
```
...
file_file_repository = pulpcore.client.pulp_rpm.FileFileRepository() # FileFileRepository | 
    ...
    try:
        # Update a file repository
        api_response = api_instance.repositories_file_file_update(file_file_repository_href, file_file_repository)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RepositoriesFileApi->repositories_file_file_update: %s\n" % e)
```

...
------------- | ------------- | -------------
[**content_rpm_modulemd_obsoletes_create**](ContentModulemdObsoletesApi.md#content_rpm_modulemd_obsoletes_create) | **POST** /api/pulp/{pulp_domain}/api/v3/content/rpm/modulemd_obsoletes/ | Create a modulemd obsolete
[**content_rpm_modulemd_obsoletes_list**](ContentModulemdObsoletesApi.md#content_rpm_modulemd_obsoletes_list) | **GET** /api/pulp/{pulp_domain}/api/v3/content/rpm/modulemd_obsoletes/ | List modulemd obsoletes

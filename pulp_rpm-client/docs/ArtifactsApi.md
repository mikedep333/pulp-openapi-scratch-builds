# pulpcore.client.pulp_rpm.ArtifactsApi

All URIs are relative to *http://localhost:8000*

Method | HTTP request | Description
------------- | ------------- | -------------
[**artifacts_create**](ArtifactsApi.md#artifacts_create) | **POST** /api/pulp/{pulp_domain}/api/v3/artifacts/ | Create an artifact
[**artifacts_delete**](ArtifactsApi.md#artifacts_delete) | **DELETE** {artifact_href} | Delete an artifact
[**artifacts_list**](ArtifactsApi.md#artifacts_list) | **GET** /api/pulp/{pulp_domain}/api/v3/artifacts/ | List artifacts
[**artifacts_read**](ArtifactsApi.md#artifacts_read) | **GET** {artifact_href} | Inspect an artifact


# **artifacts_create**
> ArtifactResponse artifacts_create(pulp_domain, file, size=size, md5=md5, sha1=sha1, sha224=sha224, sha256=sha256, sha384=sha384, sha512=sha512)
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.ArtifactsApi(api_client)
...
sha512 = 'sha512_example' # str | The SHA-512 checksum of the file if available. (optional)
    ...
    try:
        # Create an artifact
        api_response = api_instance.artifacts_create(pulp_domain, file, size=size, md5=md5, sha1=sha1, sha224=sha224, sha256=sha256, sha384=sha384, sha512=sha512)
        pprint(api_response)
...
# **artifacts_list**
> PaginatedArtifactResponseList artifacts_list(pulp_domain, limit=limit, md5=md5, offset=offset, ordering=ordering, orphaned_for=orphaned_for, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, q=q, repository_version=repository_version, sha1=sha1, sha224=sha224, sha256=sha256, sha384=sha384, sha512=sha512, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List artifacts
        api_response = api_instance.artifacts_list(pulp_domain, limit=limit, md5=md5, offset=offset, ordering=ordering, orphaned_for=orphaned_for, pulp_href__in=pulp_href__in, pulp_id__in=pulp_id__in, q=q, repository_version=repository_version, sha1=sha1, sha224=sha224, sha256=sha256, sha384=sha384, sha512=sha512, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
...
# **artifacts_read**
> ArtifactResponse artifacts_read(artifact_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect an artifact
        api_response = api_instance.artifacts_read(artifact_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:

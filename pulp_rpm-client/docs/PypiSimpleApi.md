# pulpcore.client.pulp_rpm.PypiSimpleApi

All URIs are relative to *http://localhost:8000*

Method | HTTP request | Description
------------- | ------------- | -------------
[**pypi_simple_create**](PypiSimpleApi.md#pypi_simple_create) | **POST** /pypi/{pulp_domain}/{path}/simple/ | Upload a package
...
[**pypi_simple_read**](PypiSimpleApi.md#pypi_simple_read) | **GET** /pypi/{pulp_domain}/{path}/simple/ | Get index simple page


# **pypi_simple_create**
> PackageUploadTaskResponse pypi_simple_create(path, pulp_domain, content, sha256_digest, action=action)
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.PypiSimpleApi(api_client)
...
action = 'file_upload' # str | Defaults to `file_upload`, don't change it or request will fail! (optional) (default to 'file_upload')
    ...
    try:
        # Upload a package
        api_response = api_instance.pypi_simple_create(path, pulp_domain, content, sha256_digest, action=action)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PypiSimpleApi->pypi_simple_create: %s\n" % e)
```
...
# **pypi_simple_read**
> pypi_simple_read(path, pulp_domain, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Get index simple page
        api_instance.pypi_simple_read(path, pulp_domain, fields=fields, exclude_fields=exclude_fields)
    except ApiException as e:
        print("Exception when calling PypiSimpleApi->pypi_simple_read: %s\n" % e)
```

# pulpcore.client.pulp_rpm.GroupsUsersApi
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulp_rpm.GroupsUsersApi(api_client)
    group_href = 'group_href_example' # str | 
group_user = pulpcore.client.pulp_rpm.GroupUser() # GroupUser | 

    try:
        # Create an user
        api_response = api_instance.groups_users_create(group_href, group_user)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GroupsUsersApi->groups_users_create: %s\n" % e)
```
...
with pulpcore.client.pulp_rpm.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling GroupsUsersApi->groups_users_delete: %s\n" % e)
```
...
# **groups_users_list**
> PaginatedGroupUserResponseList groups_users_list(group_href, limit=limit, offset=offset, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = ['exclude_fields_example'] # list[str] | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List users
        api_response = api_instance.groups_users_list(group_href, limit=limit, offset=offset, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GroupsUsersApi->groups_users_list: %s\n" % e)
```

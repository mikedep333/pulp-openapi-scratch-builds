...
class PythonPythonPackageContent(object):
    ...
    @property
    def url(self):
        """Gets the url of this PythonPythonPackageContent.  # noqa: E501

        A url that Pulp can download and turn into the content unit.  # noqa: E501

        :return: The url of this PythonPythonPackageContent.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this PythonPythonPackageContent.

        A url that Pulp can download and turn into the content unit.  # noqa: E501

        :param url: The url of this PythonPythonPackageContent.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and

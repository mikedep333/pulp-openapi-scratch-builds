...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, hidden=False, pulp_href=None, pulp_last_updated=None, base_url=None, pulp_labels=None, content_guard=None, base_path=None, name=None, local_vars_configuration=None):  # noqa: E501

...
class ContentModulemdObsoletesApi(object):
    ...
    def content_rpm_modulemd_obsoletes_create(self, rpm_modulemd_obsolete, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.content_rpm_modulemd_obsoletes_create(pulp_domain, rpm_modulemd_obsolete, async_req=True)
        >>> result = thread.get()
        ...
        return self.content_rpm_modulemd_obsoletes_create_with_http_info(rpm_modulemd_obsolete, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_rpm_modulemd_obsoletes_create_with_http_info(self, rpm_modulemd_obsolete, pulp_domain="default", **kwargs):  # noqa: E501
        """Create a modulemd obsolete  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_rpm_modulemd_obsoletes_create_with_http_info(pulp_domain, rpm_modulemd_obsolete, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method content_rpm_modulemd_obsoletes_create" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_rpm_modulemd_obsoletes_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rpm_modulemd_obsolete' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `rpm_modulemd_obsolete` when calling `content_rpm_modulemd_obsoletes_create`")  # noqa: E501
    ...
    def content_rpm_modulemd_obsoletes_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List modulemd obsoletes  # noqa: E501

        ViewSet for Modulemd.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_rpm_modulemd_obsoletes_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_rpm_modulemd_obsoletes_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_rpm_modulemd_obsoletes_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List modulemd obsoletes  # noqa: E501

        ViewSet for Modulemd.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_rpm_modulemd_obsoletes_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_rpm_modulemd_obsoletes_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pulp_domain' is set
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_rpm_modulemd_obsoletes_list`")  # noqa: E501
    ...
    def content_rpm_modulemd_obsoletes_read(self, rpm_modulemd_obsolete_href,  **kwargs):  # noqa: E501
        """Inspect a modulemd obsolete  # noqa: E501

        ViewSet for Modulemd.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_rpm_modulemd_obsoletes_read(rpm_modulemd_obsolete_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_rpm_modulemd_obsoletes_read_with_http_info(rpm_modulemd_obsolete_href,  **kwargs)  # noqa: E501

    def content_rpm_modulemd_obsoletes_read_with_http_info(self, rpm_modulemd_obsolete_href,  **kwargs):  # noqa: E501
        """Inspect a modulemd obsolete  # noqa: E501

        ViewSet for Modulemd.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_rpm_modulemd_obsoletes_read_with_http_info(rpm_modulemd_obsolete_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_rpm_modulemd_obsoletes_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('rpm_modulemd_obsolete_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `rpm_modulemd_obsolete_href` when calling `content_rpm_modulemd_obsoletes_read`")  # noqa: E501

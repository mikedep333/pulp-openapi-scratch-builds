...
class RepairApi(object):
    ...
    def repair_post(self, repair, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.repair_post(pulp_domain, repair, async_req=True)
        >>> result = thread.get()
        ...
        return self.repair_post_with_http_info(repair, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def repair_post_with_http_info(self, repair, pulp_domain="default", **kwargs):  # noqa: E501
        """Repair Artifact Storage  # noqa: E501

        Trigger an asynchronous task that checks for missing or corrupted artifacts, and attempts to redownload them.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair_post_with_http_info(pulp_domain, repair, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `repair_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('repair' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `repair` when calling `repair_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/repair/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

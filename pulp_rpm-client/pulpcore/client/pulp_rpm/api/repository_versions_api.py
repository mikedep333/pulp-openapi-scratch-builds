...
class RepositoryVersionsApi(object):
    ...
    def repository_versions_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.repository_versions_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.repository_versions_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def repository_versions_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        A mixin to hold the shared get_queryset logic used by RepositoryVersionViewSets.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repository_versions_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method repository_versions_list" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `repository_versions_list`")  # noqa: E501

...
class PypiMetadataApi(object):
    ...
    def pypi_pypi_read(self, meta, path, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.pypi_pypi_read(meta, path, pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.pypi_pypi_read_with_http_info(meta, path, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def pypi_pypi_read_with_http_info(self, meta, path, pulp_domain="default", **kwargs):  # noqa: E501
        """Get package metadata  # noqa: E501

        Retrieves the package's core-metadata specified by https://packaging.python.org/specifications/core-metadata/. `meta` must be a path in form of `{package}/json/` or `{package}/{version}/json/`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_pypi_read_with_http_info(meta, path, pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('meta' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `meta` when calling `pypi_pypi_read`")  # noqa: E501
        # verify the required parameter 'path' is set
        if self.api_client.client_side_validation and ('path' not in local_var_params or  # noqa: E501
                                                        local_var_params['path'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `path` when calling `pypi_pypi_read`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `pypi_pypi_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pypi/{pulp_domain}/{path}/pypi/{meta}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

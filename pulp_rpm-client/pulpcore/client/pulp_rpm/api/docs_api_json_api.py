...
class DocsApiJsonApi(object):
    ...
    def docs_api_json_get(self,  **kwargs):  # noqa: E501
        """docs_api_json_get  # noqa: E501
        ...
        >>> thread = api.docs_api_json_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.docs_api_json_get_with_http_info( **kwargs)  # noqa: E501

    def docs_api_json_get_with_http_info(self,  **kwargs):  # noqa: E501
        """docs_api_json_get  # noqa: E501

        OpenApi3 schema for this API. Format can be selected via content negotiation.  - YAML: application/vnd.oai.openapi - JSON: application/vnd.oai.openapi+json  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.docs_api_json_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method docs_api_json_get" % key
                )
        ...
        return self.api_client.call_api(
            '/api/pulp/api/v3/docs/api.json', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

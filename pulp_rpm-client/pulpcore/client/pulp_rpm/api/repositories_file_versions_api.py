...
class RepositoriesFileVersionsApi(object):
    ...
    def repositories_file_file_versions_delete(self, file_file_repository_version_href,  **kwargs):  # noqa: E501
        ...
        >>> thread = api.repositories_file_file_versions_delete(file_file_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        return self.repositories_file_file_versions_delete_with_http_info(file_file_repository_version_href,  **kwargs)  # noqa: E501

    def repositories_file_file_versions_delete_with_http_info(self, file_file_repository_version_href,  **kwargs):  # noqa: E501
        """Delete a repository version  # noqa: E501

        Trigger an asynchronous task to delete a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_delete_with_http_info(file_file_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method repositories_file_file_versions_delete" % key
                )
        ...
        if self.api_client.client_side_validation and ('file_file_repository_version_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `file_file_repository_version_href` when calling `repositories_file_file_versions_delete`")  # noqa: E501
    ...
    def repositories_file_file_versions_list(self, file_file_repository_href,  **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

         FileRepositoryVersion represents a single file repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_list(file_file_repository_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repositories_file_file_versions_list_with_http_info(file_file_repository_href,  **kwargs)  # noqa: E501

    def repositories_file_file_versions_list_with_http_info(self, file_file_repository_href,  **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

         FileRepositoryVersion represents a single file repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_list_with_http_info(file_file_repository_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repositories_file_file_versions_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('file_file_repository_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `file_file_repository_href` when calling `repositories_file_file_versions_list`")  # noqa: E501
    ...
    def repositories_file_file_versions_read(self, file_file_repository_version_href,  **kwargs):  # noqa: E501
        """Inspect a repository version  # noqa: E501

         FileRepositoryVersion represents a single file repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_read(file_file_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repositories_file_file_versions_read_with_http_info(file_file_repository_version_href,  **kwargs)  # noqa: E501

    def repositories_file_file_versions_read_with_http_info(self, file_file_repository_version_href,  **kwargs):  # noqa: E501
        """Inspect a repository version  # noqa: E501

         FileRepositoryVersion represents a single file repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_read_with_http_info(file_file_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repositories_file_file_versions_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'file_file_repository_version_href' is set
        if self.api_client.client_side_validation and ('file_file_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['file_file_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file_file_repository_version_href` when calling `repositories_file_file_versions_read`")  # noqa: E501
    ...
    def repositories_file_file_versions_repair(self, file_file_repository_version_href, repair,  **kwargs):  # noqa: E501
        """repositories_file_file_versions_repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_repair(file_file_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repositories_file_file_versions_repair_with_http_info(file_file_repository_version_href, repair,  **kwargs)  # noqa: E501

    def repositories_file_file_versions_repair_with_http_info(self, file_file_repository_version_href, repair,  **kwargs):  # noqa: E501
        """repositories_file_file_versions_repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_file_file_versions_repair_with_http_info(file_file_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repositories_file_file_versions_repair" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'file_file_repository_version_href' is set
        if self.api_client.client_side_validation and ('file_file_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['file_file_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file_file_repository_version_href` when calling `repositories_file_file_versions_repair`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('repair' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `repair` when calling `repositories_file_file_versions_repair`")  # noqa: E501

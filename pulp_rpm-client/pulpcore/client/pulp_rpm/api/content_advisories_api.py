...
class ContentAdvisoriesApi(object):
    ...
    def content_rpm_advisories_create_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('file_url' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `file_url` when calling `content_rpm_advisories_create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}

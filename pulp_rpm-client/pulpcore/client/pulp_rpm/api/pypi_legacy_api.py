...
class PypiLegacyApi(object):
    ...
    def pypi_legacy_create(self, path, content, sha256_digest, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.pypi_legacy_create(path, pulp_domain, content, sha256_digest, async_req=True)
        >>> result = thread.get()
        ...
        return self.pypi_legacy_create_with_http_info(path, content, sha256_digest, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def pypi_legacy_create_with_http_info(self, path, content, sha256_digest, pulp_domain="default", **kwargs):  # noqa: E501
        """Upload a package  # noqa: E501

        Upload package to the index.  This is the endpoint that tools like Twine and Poetry use for their upload commands.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_legacy_create_with_http_info(path, pulp_domain, content, sha256_digest, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method pypi_legacy_create" % key
                )
        ...
        if self.api_client.client_side_validation and ('path' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `path` when calling `pypi_legacy_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `pypi_legacy_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('content' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `content` when calling `pypi_legacy_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sha256_digest' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `sha256_digest` when calling `pypi_legacy_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sha256_digest' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `sha256_digest` when calling `pypi_legacy_create`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('sha256_digest' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sha256_digest']) < 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sha256_digest` when calling `pypi_legacy_create`, length must be greater than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('action' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `action` when calling `pypi_legacy_create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/pypi/{pulp_domain}/{path}/legacy/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

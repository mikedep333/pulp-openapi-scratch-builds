...
class DistributionsApi(object):
    ...
    def distributions_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List distributions  # noqa: E501

        Provides base viewset for Distributions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.distributions_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        :param str pulp_type: Pulp type  * `core.artifact` - core.artifact * `gem.gem` - gem.gem * `ostree.ostree` - ostree.ostree * `python.python` - python.python * `rpm.rpm` - rpm.rpm * `file.file` - file.file
        :param list[str] pulp_type__in: Multiple values may be separated by commas.  * `core.artifact` - core.artifact * `gem.gem` - gem.gem * `ostree.ostree` - ostree.ostree * `python.python` - python.python * `rpm.rpm` - rpm.rpm * `file.file` - file.file
        :param str q:
        ...
        return self.distributions_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def distributions_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List distributions  # noqa: E501

        Provides base viewset for Distributions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.distributions_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `distributions_list`")  # noqa: E501

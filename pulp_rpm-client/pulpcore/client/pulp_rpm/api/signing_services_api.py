...
class SigningServicesApi(object):
    ...
    def signing_services_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.signing_services_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.signing_services_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def signing_services_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List signing services  # noqa: E501

        A ViewSet that supports browsing of existing signing services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signing_services_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method signing_services_list" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `signing_services_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/signing-services/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def signing_services_read(self, signing_service_href,  **kwargs):  # noqa: E501
        """Inspect a signing service  # noqa: E501

        A ViewSet that supports browsing of existing signing services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signing_services_read(signing_service_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.signing_services_read_with_http_info(signing_service_href,  **kwargs)  # noqa: E501

    def signing_services_read_with_http_info(self, signing_service_href,  **kwargs):  # noqa: E501
        """Inspect a signing service  # noqa: E501

        A ViewSet that supports browsing of existing signing services.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signing_services_read_with_http_info(signing_service_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method signing_services_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('signing_service_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `signing_service_href` when calling `signing_services_read`")  # noqa: E501

...
class RepositoriesReclaimSpaceApi(object):
    ...
    def repositories_reclaim_space_reclaim(self, reclaim_space, pulp_domain="default", **kwargs):  # noqa: E501
        """repositories_reclaim_space_reclaim  # noqa: E501

        Trigger an asynchronous space reclaim operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_reclaim_space_reclaim(pulp_domain, reclaim_space, async_req=True)
        >>> result = thread.get()
        ...
        return self.repositories_reclaim_space_reclaim_with_http_info(reclaim_space, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def repositories_reclaim_space_reclaim_with_http_info(self, reclaim_space, pulp_domain="default", **kwargs):  # noqa: E501
        """repositories_reclaim_space_reclaim  # noqa: E501

        Trigger an asynchronous space reclaim operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repositories_reclaim_space_reclaim_with_http_info(pulp_domain, reclaim_space, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method repositories_reclaim_space_reclaim" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `repositories_reclaim_space_reclaim`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('reclaim_space' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `reclaim_space` when calling `repositories_reclaim_space_reclaim`")  # noqa: E501

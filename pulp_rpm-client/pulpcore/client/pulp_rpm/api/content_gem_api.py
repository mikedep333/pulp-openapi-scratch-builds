...
class ContentGemApi(object):
    ...
    def content_gem_gem_create(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.content_gem_gem_create(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.content_gem_gem_create_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_gem_gem_create_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """Create a gem content  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_gem_gem_create_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method content_gem_gem_create" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_gem_gem_create`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/gem/gem/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_gem_gem_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List gem contents  # noqa: E501

        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_gem_gem_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_gem_gem_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_gem_gem_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List gem contents  # noqa: E501

        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_gem_gem_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_gem_gem_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pulp_domain' is set
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_gem_gem_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/gem/gem/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_gem_gem_read(self, gem_gem_content_href,  **kwargs):  # noqa: E501
        """Inspect a gem content  # noqa: E501

        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_gem_gem_read(gem_gem_content_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_gem_gem_read_with_http_info(gem_gem_content_href,  **kwargs)  # noqa: E501

    def content_gem_gem_read_with_http_info(self, gem_gem_content_href,  **kwargs):  # noqa: E501
        """Inspect a gem content  # noqa: E501

        A ViewSet for GemContent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_gem_gem_read_with_http_info(gem_gem_content_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_gem_gem_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('gem_gem_content_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `gem_gem_content_href` when calling `content_gem_gem_read`")  # noqa: E501

...
class ContentConfigsApi(object):
    ...
    def content_ostree_configs_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree configs  # noqa: E501

        A ViewSet class for OSTree repository configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_configs_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.content_ostree_configs_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_ostree_configs_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree configs  # noqa: E501

        A ViewSet class for OSTree repository configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_configs_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method content_ostree_configs_list" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_ostree_configs_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/ostree/configs/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_ostree_configs_read(self, ostree_ostree_config_href,  **kwargs):  # noqa: E501
        """Inspect an ostree config  # noqa: E501

        A ViewSet class for OSTree repository configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_configs_read(ostree_ostree_config_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_ostree_configs_read_with_http_info(ostree_ostree_config_href,  **kwargs)  # noqa: E501

    def content_ostree_configs_read_with_http_info(self, ostree_ostree_config_href,  **kwargs):  # noqa: E501
        """Inspect an ostree config  # noqa: E501

        A ViewSet class for OSTree repository configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_configs_read_with_http_info(ostree_ostree_config_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_ostree_configs_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_config_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ostree_ostree_config_href` when calling `content_ostree_configs_read`")  # noqa: E501

...
class PypiSimpleApi(object):
    ...
    def pypi_simple_create(self, path, content, sha256_digest, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.pypi_simple_create(path, pulp_domain, content, sha256_digest, async_req=True)
        >>> result = thread.get()
        ...
        return self.pypi_simple_create_with_http_info(path, content, sha256_digest, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def pypi_simple_create_with_http_info(self, path, content, sha256_digest, pulp_domain="default", **kwargs):  # noqa: E501
        """Upload a package  # noqa: E501

        Upload package to the index. This endpoint has the same functionality as the upload endpoint at the `/legacy` url of the index. This is provided for convenience for users who want a single index url for all their Python tools. (pip, twine, poetry, pipenv, ...)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_simple_create_with_http_info(path, pulp_domain, content, sha256_digest, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method pypi_simple_create" % key
                )
        ...
        if self.api_client.client_side_validation and ('path' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `path` when calling `pypi_simple_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `pypi_simple_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('content' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `content` when calling `pypi_simple_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sha256_digest' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `sha256_digest` when calling `pypi_simple_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sha256_digest' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `sha256_digest` when calling `pypi_simple_create`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('sha256_digest' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sha256_digest']) < 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sha256_digest` when calling `pypi_simple_create`, length must be greater than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('action' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `action` when calling `pypi_simple_create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/pypi/{pulp_domain}/{path}/simple/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def pypi_simple_package_read(self, package, path, pulp_domain="default", **kwargs):  # noqa: E501
        """Get package simple page  # noqa: E501

        Retrieves the simple api html page for a package.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_simple_package_read(package, path, pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.pypi_simple_package_read_with_http_info(package, path, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def pypi_simple_package_read_with_http_info(self, package, path, pulp_domain="default", **kwargs):  # noqa: E501
        """Get package simple page  # noqa: E501

        Retrieves the simple api html page for a package.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_simple_package_read_with_http_info(package, path, pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `pypi_simple_package_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pypi/{pulp_domain}/{path}/simple/{package}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def pypi_simple_read(self, path, pulp_domain="default", **kwargs):  # noqa: E501
        """Get index simple page  # noqa: E501

        Gets the simple api html page for the index.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_simple_read(path, pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.pypi_simple_read_with_http_info(path, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def pypi_simple_read_with_http_info(self, path, pulp_domain="default", **kwargs):  # noqa: E501
        """Get index simple page  # noqa: E501

        Gets the simple api html page for the index.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pypi_simple_read_with_http_info(path, pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pypi_simple_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'path' is set
        if self.api_client.client_side_validation and ('path' not in local_var_params or  # noqa: E501
                                                        local_var_params['path'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `path` when calling `pypi_simple_read`")  # noqa: E501
        # verify the required parameter 'pulp_domain' is set
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `pypi_simple_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pypi/{pulp_domain}/{path}/simple/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

...
class ContentObjectsApi(object):
    ...
    def content_ostree_objects_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.content_ostree_objects_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.content_ostree_objects_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_ostree_objects_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree objects  # noqa: E501

        A ViewSet class for OSTree objects (e.g., dirtree, dirmeta, file).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_objects_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method content_ostree_objects_list" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_ostree_objects_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/ostree/objects/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_ostree_objects_read(self, ostree_ostree_object_href,  **kwargs):  # noqa: E501
        """Inspect an ostree object  # noqa: E501

        A ViewSet class for OSTree objects (e.g., dirtree, dirmeta, file).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_objects_read(ostree_ostree_object_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_ostree_objects_read_with_http_info(ostree_ostree_object_href,  **kwargs)  # noqa: E501

    def content_ostree_objects_read_with_http_info(self, ostree_ostree_object_href,  **kwargs):  # noqa: E501
        """Inspect an ostree object  # noqa: E501

        A ViewSet class for OSTree objects (e.g., dirtree, dirmeta, file).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_objects_read_with_http_info(ostree_ostree_object_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_ostree_objects_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_object_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ostree_ostree_object_href` when calling `content_ostree_objects_read`")  # noqa: E501

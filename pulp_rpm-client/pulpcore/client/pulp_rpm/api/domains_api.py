...
class DomainsApi(object):
    ...
    def domains_create(self, domain, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.domains_create(pulp_domain, domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.domains_create_with_http_info(domain, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def domains_create_with_http_info(self, domain, pulp_domain="default", **kwargs):  # noqa: E501
        """Create a domain  # noqa: E501

        ViewSet for Domain.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_create_with_http_info(pulp_domain, domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `domains_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `domain` when calling `domains_create`")  # noqa: E501
    ...
    def domains_delete(self, domain_href,  **kwargs):  # noqa: E501
        """Delete a domain  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_delete(domain_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.domains_delete_with_http_info(domain_href,  **kwargs)  # noqa: E501

    def domains_delete_with_http_info(self, domain_href,  **kwargs):  # noqa: E501
        """Delete a domain  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_delete_with_http_info(domain_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('domain_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `domain_href` when calling `domains_delete`")  # noqa: E501
    ...
    def domains_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List domains  # noqa: E501

        ViewSet for Domain.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.domains_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def domains_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List domains  # noqa: E501

        ViewSet for Domain.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `domains_list`")  # noqa: E501
    ...
    def domains_partial_update(self, domain_href, patched_domain,  **kwargs):  # noqa: E501
        """Update a domain  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_partial_update(domain_href, patched_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.domains_partial_update_with_http_info(domain_href, patched_domain,  **kwargs)  # noqa: E501

    def domains_partial_update_with_http_info(self, domain_href, patched_domain,  **kwargs):  # noqa: E501
        """Update a domain  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_partial_update_with_http_info(domain_href, patched_domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('domain_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['domain_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `domain_href` when calling `domains_partial_update`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('patched_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `patched_domain` when calling `domains_partial_update`")  # noqa: E501
    ...
    def domains_read(self, domain_href,  **kwargs):  # noqa: E501
        """Inspect a domain  # noqa: E501

        ViewSet for Domain.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_read(domain_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.domains_read_with_http_info(domain_href,  **kwargs)  # noqa: E501

    def domains_read_with_http_info(self, domain_href,  **kwargs):  # noqa: E501
        """Inspect a domain  # noqa: E501

        ViewSet for Domain.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_read_with_http_info(domain_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('domain_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['domain_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `domain_href` when calling `domains_read`")  # noqa: E501
    ...
    def domains_update(self, domain_href, domain,  **kwargs):  # noqa: E501
        """Update a domain  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_update(domain_href, domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.domains_update_with_http_info(domain_href, domain,  **kwargs)  # noqa: E501

    def domains_update_with_http_info(self, domain_href, domain,  **kwargs):  # noqa: E501
        """Update a domain  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.domains_update_with_http_info(domain_href, domain, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('domain_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['domain_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `domain_href` when calling `domains_update`")  # noqa: E501
        # verify the required parameter 'domain' is set
        if self.api_client.client_side_validation and ('domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `domain` when calling `domains_update`")  # noqa: E501

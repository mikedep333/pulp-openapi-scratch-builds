...
class ContentContentApi(object):
    ...
    def content_ostree_content_create(self, ostree_ostree_content, pulp_domain="default", **kwargs):  # noqa: E501
        ...
        >>> thread = api.content_ostree_content_create(pulp_domain, ostree_ostree_content, async_req=True)
        >>> result = thread.get()
        ...
        return self.content_ostree_content_create_with_http_info(ostree_ostree_content, pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_ostree_content_create_with_http_info(self, ostree_ostree_content, pulp_domain="default", **kwargs):  # noqa: E501
        """Create an ostree content  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_content_create_with_http_info(pulp_domain, ostree_ostree_content, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method content_ostree_content_create" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_ostree_content_create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_content' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ostree_ostree_content` when calling `content_ostree_content_create`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/ostree/content/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_ostree_content_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree contents  # noqa: E501

        A ViewSet class for uncategorized content units (e.g., static deltas).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_content_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_ostree_content_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_ostree_content_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree contents  # noqa: E501

        A ViewSet class for uncategorized content units (e.g., static deltas).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_content_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_ostree_content_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pulp_domain' is set
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_ostree_content_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/ostree/content/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_ostree_content_read(self, ostree_ostree_content_href,  **kwargs):  # noqa: E501
        """Inspect an ostree content  # noqa: E501

        A ViewSet class for uncategorized content units (e.g., static deltas).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_content_read(ostree_ostree_content_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_ostree_content_read_with_http_info(ostree_ostree_content_href,  **kwargs)  # noqa: E501

    def content_ostree_content_read_with_http_info(self, ostree_ostree_content_href,  **kwargs):  # noqa: E501
        """Inspect an ostree content  # noqa: E501

        A ViewSet class for uncategorized content units (e.g., static deltas).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_content_read_with_http_info(ostree_ostree_content_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_ostree_content_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_content_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ostree_ostree_content_href` when calling `content_ostree_content_read`")  # noqa: E501

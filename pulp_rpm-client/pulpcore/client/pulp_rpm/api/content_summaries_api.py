...
class ContentSummariesApi(object):
    ...
    def content_ostree_summaries_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree summarys  # noqa: E501

        A ViewSet class for OSTree repository summary files.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_summaries_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.content_ostree_summaries_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def content_ostree_summaries_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List ostree summarys  # noqa: E501

        A ViewSet class for OSTree repository summary files.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_summaries_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method content_ostree_summaries_list" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `content_ostree_summaries_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/pulp/{pulp_domain}/api/v3/content/ostree/summaries/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def content_ostree_summaries_read(self, ostree_ostree_summary_href,  **kwargs):  # noqa: E501
        """Inspect an ostree summary  # noqa: E501

        A ViewSet class for OSTree repository summary files.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_summaries_read(ostree_ostree_summary_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.content_ostree_summaries_read_with_http_info(ostree_ostree_summary_href,  **kwargs)  # noqa: E501

    def content_ostree_summaries_read_with_http_info(self, ostree_ostree_summary_href,  **kwargs):  # noqa: E501
        """Inspect an ostree summary  # noqa: E501

        A ViewSet class for OSTree repository summary files.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.content_ostree_summaries_read_with_http_info(ostree_ostree_summary_href, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method content_ostree_summaries_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_summary_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `ostree_ostree_summary_href` when calling `content_ostree_summaries_read`")  # noqa: E501

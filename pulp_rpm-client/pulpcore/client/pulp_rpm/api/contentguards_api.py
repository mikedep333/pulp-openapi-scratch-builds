...
class ContentguardsApi(object):
    ...
    def contentguards_list(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List content guards  # noqa: E501

        Endpoint to list all contentguards.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contentguards_list(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.contentguards_list_with_http_info(pulp_domain=pulp_domain, **kwargs)  # noqa: E501

    def contentguards_list_with_http_info(self, pulp_domain="default", **kwargs):  # noqa: E501
        """List content guards  # noqa: E501

        Endpoint to list all contentguards.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contentguards_list_with_http_info(pulp_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method contentguards_list" % key
                )
        ...
        if self.api_client.client_side_validation and ('pulp_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pulp_domain` when calling `contentguards_list`")  # noqa: E501
